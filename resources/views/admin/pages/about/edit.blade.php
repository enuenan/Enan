                ...
                <div class="panel-body">
                    <form action="{{ route('about.update', $about) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3">
                                <img src="{{ $about->image }}" class="img-fluid" alt="" id="previewImg">
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control m-b-5" id="title" name="title"
                                    placeholder="Enter title" value="{{ old('title') ? old('title') : $about->title }}"
                                    required />
                                @error('title')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" class="form-control m-b-5" id="description" name="description"
                                    ...
                                    required>{{ old('description') ? old('description') : $about->description }}</textarea>
                                @error('description')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
