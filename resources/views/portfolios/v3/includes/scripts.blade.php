...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const onScroll = function () {
            ...
            if (header) {
                header.classList.toggle('py-1', window.scrollY > 20);
            ...
            document.querySelectorAll('#portfolio-flters li').forEach(function (filter) {
                filter.addEventListener('click', function () {
                    document.querySelectorAll('#portfolio-flters li').forEach(function (item) {
                        item.classList.remove('bg-orange-400', 'text-neutral-950');
                        item.classList.add('bg-white', 'text-neutral-800');
                    });
                    this.classList.add('bg-orange-400', 'text-neutral-950');
                    this.classList.remove('bg-white', 'text-neutral-800');
