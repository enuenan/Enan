    ...
    <div class="mx-auto grid max-w-7xl gap-10 lg:grid-cols-12 lg:items-center">
        <div class="lg:col-span-7">
            ...
            <h1
                ...
                Moammer Farshid Enan - Laravel Web Developer
            </h1>

            <p class="mt-6 max-w-2xl text-lg leading-8 text-[#666]">I’m Moammer Farshid Enan, a Laravel web developer
                from Bangladesh. I build clean, secure, maintainable, and scalable web applications using Laravel, Vue,
                React, MySQL, Tailwind CSS, JavaScript, and modern frontend tools.</p>
            </p>
