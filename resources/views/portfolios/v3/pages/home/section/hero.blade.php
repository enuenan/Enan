<section id="hero" class="relative px-4 pb-20 pt-32 sm:px-6 lg:px-8 lg:pb-28 lg:pt-40">
    <div class="mx-auto grid max-w-7xl gap-10 lg:grid-cols-12 lg:items-center">
        <div class="lg:col-span-7">
            ...
            <h1
                class="font-display mt-8 max-w-5xl text-6xl font-black leading-[0.9] tracking-[-0.06em] text-neutral-950 sm:text-7xl lg:text-8xl">
                Code that feels clean, fast, and useful.
            </h1>

            <p class="mt-8 max-w-2xl text-xl font-medium leading-9 text-neutral-700">
                I'm <span class="typed font-black text-orange-600"
                    data-typed-items="Moammer Farshid Enan, Laravel Web Developer"></span>. I build secure Laravel
                applications, backend systems, and polished product experiences.
            </p>
        ...
        <div class="relative lg:col-span-5">
            ...
            <div
                class="relative rotate-2 rounded-4xl border-2 border-neutral-950 bg-white p-4 shadow-[12px_12px_0_#111827] transition hover:rotate-0">
                <img src="{{ asset('portfolio/assets/img/pixomatic_1702137054794.png') }}" alt="Moammer Farshid Enan"
                    class="h-130 w-full rounded-[1.4rem] border-2 border-neutral-950 object-cover object-top">
                <div
