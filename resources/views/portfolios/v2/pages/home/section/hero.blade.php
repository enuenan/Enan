<section id="hero" class="relative min-h-screen overflow-hidden px-4 pt-32 sm:px-6 lg:px-8">
    ...
    <div class="mx-auto grid min-h-[calc(100vh-8rem)] max-w-7xl items-center gap-14 lg:grid-cols-12">
        ...
        <div class="relative lg:col-span-5">
            <div
                class="absolute -inset-6 rounded-[3rem] bg-gradient-to-br from-emerald-300/20 via-teal-300/10 to-transparent blur-2xl">
            </div>
            <div
                class="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/5 p-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
                <img src="{{ asset('portfolio/assets/img/pixomatic_1702137054794.png') }}" alt="Moammer Farshid Enan"
                    class="h-[520px] w-full rounded-3xl object-cover object-top">
                <div
