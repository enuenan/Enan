    ...
    <div class="container">
        ...
        <div class="row portfolio-container">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <img src="{{ asset('portfolio/assets/img/portfolio/pixomatic_1629475757619.png') }}" class="img-fluid"
                    alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                <img src="{{ asset('portfolio/assets/img/portfolio/pixomatic_1629477345430.png') }}" class="img-fluid"
                    alt="">
                <div class="portfolio-info">
                    <h4>Docror's Blog</h4>
                    <p>Docror's Blog</p>
            ...
            <!-- 3 -->
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                <img src="{{ asset('portfolio/assets/img/portfolio/pixomatic_1629477617026.png') }}" class="img-fluid"
                    alt="">
                <div class="portfolio-info">
                    <h4>EL-MO1 CARS</h4>
                    <p>EL-MO1 CARS</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <img src="{{ asset('portfolio/assets/img/portfolio/pixomatic_1629477935633.png') }}" class="img-fluid"
                    alt="">
                <div class="portfolio-info">
                    <h4>Daruchini</h4>
                    <p>Daruchini</p>
